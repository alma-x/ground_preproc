...
class ImagePreprocessor:
    ...
    def __init__(self):
        ...
        camera_dict = { 'HazCam': "/camera/image_raw",
                        ...
                        'noisyHazCam':"/camera/image_raw/noisy",
                        'prprocHazCam':"/camera/image_raw/preproc"}
                        
		SIMULATE_NOISE = False#! rospy.get_param('/gara',True)
          
        #self.input_topic = rospy.get_param(
        #    '/image_preproc/noisy_camera_topic',camera_dict['nsyHazCam'])
	    self.input_topic = camera_dict['NavCam']) if SIMULATE_NOISE \
	    			  else camera_dict['noisyHazCam'])
